...
<template>
	<view class="components-theme">
		<!-- 侧边小鸭子 app-id:为弹出内容-->
		<navigator target="miniProgram" app-id='wx56284897b844dcac' version='release' hover-class="none">
			<view class="dong">
				<view class="monster">
		...
		<block>
			...
			<!-- <view class='padding flex text-center text-grey bg-white shadow-warp-my'>
				...
				<view class='flex flex-sub flex-direction' :style="[{animation: 'show ' + 0.6+ 's 1'}]">
			...
			<view
				...
				<view class="cu-item" @tap="showModal" data-target="Modal">
					<view class='content' :style="[{animationDelay: '0.4s'}]">
			...
			<view
				...
				<!-- <view class="cu-item " @click="goCourse" :style="[{animation: 'show ' + 0.6+ 's 1'}]">
					<button class='content cu-btn'>
						...
						<text class='text-lg margin-sm'>加入企业</text>
					</button>
				</view> -->
				...
				<view class="cu-item" data-number="1084415961"
					...
					<view class="action">
						<view class="cu-tag round bg-blue light">151 7867 2798</view>
					</view>
				</view>
				...
				<!-- 退出 -->
				<view class="cu-item" :style="[{animation: 'show ' + 0.6+ 's 1'}]">
					<button class='content cu-btn' @click="signOut">
						<image src='../../static/me/icon/tuichu.png' class='png' mode='aspectFit'></image>
						<text class='text-lg margin-sm'>退出</text>
					</button>
				</view>
			</view>
